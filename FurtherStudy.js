...
//Code Here
let postTaxPrices = prices.map(priceMaker => Math.round(priceMaker * 1.07))
//console.log(postTaxPrices)



////////// PROBLEM 3 //////////Completed! Mulitple ways done!
...
//Code Here
const total = (total, curVal) => {
  return total + curVal
}
let totalPop = populations.reduce(total)
//console.log(totalPop)

//Complicated, but all on 1 line
// let totalPop = populations.reduce((total = (total, curVal) => total + curVal))
// console.log(totalPop)

// function adder (acc, curVal) {
//   return acc + curVal
// }
// let totalPop = populations.reduce(adder => adder())
//let totalPop = populations.reduce(adder)
//console.log(totalPop)
// total = 0
...
//let myStrongest = monstersInYourPocket.filter(monsterOver200)/* Provide Your Callback Here */
//console.log(myStrongest)



////////// PROBLEM 5 //////////Completed, but HOW DO I ROUND?
...
*/
const priceTax = (obj) => {
  //console.log(obj.price, obj.tax)
  return obj.price * (obj.tax + 1)
}

let orderTotals = orders.map(priceTax)// Code here
//console.log(orderTotals)



////////// PROBLEM 6 //////////Completed NOt easy
...
*/
const purchaseTotal = (value, currentTotal) => {
  //console.log(value)
  //console.log(currentTotal.price)

  return value += currentTotal.price
}
let bobsTotal = purchases.reduce(purchaseTotal,0)//Code Here
...
var carDetails = {
  ...
  */
  ...
  //Or
  let {color: c, make: ma, model: mo, year:y } =carDetails //BETTER!!!!!
  //console.log(c,ma, mo, y)  

  ////////// PROBLEM 2 //////////Completed, but no test (write one if bored)
  ...
  */
  ...
  ////////// PROBLEM 3 //////////Completed, is there an efficent way to sum up the values?
  
  /*
    Write a function called totalPop that will take in an object.
...
//console.log(totalPopulation(state)) 
  ...
  ////////// PROBLEM 4 //////////Completed! Efficency could prob be improved!
...
const ingredients = obj => {
  let {carb: c, fat: f, protein: p} = obj
  let arr = []
  arr.push(c,f,p)
  return arr
}
let foodArray = ingredients(food)
...
let product = {
  ...
  // console.log(colors)
  // colorsCopy[5] = 'Super duper ridiculously bright pink!'
